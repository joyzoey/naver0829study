...
<div>
   ...
   <c:forEach var="dto" items="${glist}">
      <div class="guest_box">
         ...
         <img src="https://nckd4w2m1718.edge.naverncp.com/kKg4OF5EO3/guest/${dto.guest_photo}?type=f&w=100&h=100&faceopt=true&ttype=jpg"  
         class="img_thumbnail smallphoto" style="float: left; margin-rigth:10px; cursor:pointer;"
...
<script type="text/javascript">
   $("img.smallphoto").click(function(){
      ...
      //모달다이얼로그에 사진넣기
      $("img.largePhoto").attr("src",`https://kr.object.ncloudstorage.com/guest-nh/guest/\${photoname}`);
   });
</script>
</body>
</html>
