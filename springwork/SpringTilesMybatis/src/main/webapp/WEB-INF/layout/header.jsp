...
$(function(){
	...
	$("#btnlogin").click(function(){
		let saveid=$("#saveid").is(":checked");//ischecked는 trueflase나오게함, val은 체크여부와 상관없이 무조건 on나옴
		let myid=$("#login_myid").val();
		let pass=$("#login_pass").val();
		//alert(saveid+","+login_myid);//ischecked가 truefalse뱉는거 확인
		...
		$.ajax({
			...
			success:function(res){
				//성공여부:res.success
				if(res.success){
					$("#btnclose").trigger("click");//강제로 닫기 버튼 클릭
