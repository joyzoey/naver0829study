...
<!-- 이미지 출력할곳 -->
 ...
 style="position: absolute;left:570px;top:65px;max-width: 300px;"
 onerror="this.style.display='none';"><!-- error가 발생하면 안보이게 처리 (해당파일 없을때) -->
			...
			<tr>
				...
				<td class="input-group">
					...
					<input type="file" name="upload" id="upload"
						style="display:none;">
					<!-- visibility는 안 보이게 만들어도 자리를 차지함
							그래서 display none으로 해야 함 -->
			...
			<tr>
				...
				<td>
					<textarea style="width: 100%;height: 150px;" name="content" 
						required="required" class="form-control"><%=dto.getContent() %></textarea>
				</td>
			</tr>
			<tr>
